...
import com.easymvc.web.bean.*;
import com.easymvc.web.helper.ConfigHelper;
import com.easymvc.web.helper.ControllerHelper;
import com.easymvc.web.utils.JsonUtil;
import com.easymvc.web.utils.ParameterUtil;
import com.easymvc.web.utils.StringUtil;
	...
	private static void handleViewResult(ModelAndView view, HttpServletRequest req, HttpServletResponse resp)
		...
		if (StringUtil.isNotEmpty(path)) {
			if (path.startsWith("/")) {
				...
				view.getAttribute().entrySet().forEach(entry -> req.setAttribute(entry.getKey(), entry.getValue()));
